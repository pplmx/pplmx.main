...
function change() {
    let song = ["乾坤鸣动", "飞雪玉花", "国色天香", "罗生堂下", "纵横天下", "谁主沉浮", "阴阳无极"];
    let songLetter = ["universe", "snow_flower", "beautiful", "hall", "invincible", "dominate", "chaos"];
    let date = new Date().getDay();
    let audio = document.getElementsByTagName("audio")[0];
    let songLi = document.getElementsByClassName("song")[0];
